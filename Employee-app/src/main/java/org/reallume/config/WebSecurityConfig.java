...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers("/accounts/**").hasAnyAuthority("create_edit_delete_account")
                .antMatchers("/cards/**").hasAnyAuthority("create_edit_delete_card")
                .antMatchers("/currencies/**").hasAnyAuthority("create_edit_delete_currency")
